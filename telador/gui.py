...
from . import fp_filter
from . import redaction
from . import pe_analysis
from . import scan_coverage as coverage_mod
from . import evidence as ev_engine
from . import report
from . import report_md
from . import scanners
from . import cli as telador
# =========================================================================
...
def _resource_path(name: str) -> str:
    """Resolve asset (dev: repo assets/, frozen: PyInstaller MEIPASS)."""
    if getattr(sys, "frozen", False):
        base = getattr(sys, "_MEIPASS", os.path.dirname(sys.executable))
        return os.path.join(base, name)
    here = os.path.dirname(os.path.abspath(__file__))
    candidates = [
        os.path.join(here, os.pardir, "assets", name),
