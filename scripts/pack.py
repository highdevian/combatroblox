...
def build_zip(
    ...
    # Bats (root) + PLAYBOOK (docs/ ou root, pra testes/legado)
    ...
    playbook = (
        _read_bytes_maybe(project_root / "docs" / "PLAYBOOK.md")
        or _read_bytes_maybe(project_root / "PLAYBOOK.md")
    )
    if playbook is not None:
        files_to_include[f"{dist_root}/PLAYBOOK.md"] = playbook
    else:
        print("[warn] arquivo opcional ausente: docs/PLAYBOOK.md")
